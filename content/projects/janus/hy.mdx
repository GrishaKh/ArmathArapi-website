...
## Roadmap to DigiCode 2026

The build is scheduled across roughly eight weeks of part-time work, with each phase gated by a binary success criterion before the next begins:

- Planning and component procurement
- Breadboard prototyping of all sensors on one sketch
- Power-rail validation, including a stress test of SIM800L bursts
- Authentication drivers for RFID and fingerprint, plus the OLED feedback loop
- Intrusion-detector state machine and buzzer driver
- GSM alert manager as a non-blocking FreeRTOS task
- Backend, database schema, and MQTT bridge
- Command Center dashboard with the live feed and logbook export
- Enclosure design, in-room mounting, and tamper switch installation
- End-to-end testing with chaos scenarios such as Wi-Fi loss mid-breach, SD-card exhaustion, and brown-out recovery

The deliverable for DigiCode 2026 is the complete system installed on a real lab door, running unattended for at least 48 hours before the demo.
