export const translations = {
  en: {
    ...
    // Student Portal
    spPortalTitle: "Student Portal",
    spPortalSignIn: "Sign in with your student credentials",
    spUsernameLabel: "Username",
    spPasswordLabel: "Password",
    spSignIn: "Sign In",
    spSigningIn: "Signing in...",
    spCredentialsHint: "Your credentials were provided by the administrator.",
    spCredentialsHint2: "Contact your admin if you need help signing in.",
    spLoadingPortal: "Loading portal...",
    spDashboard: "Dashboard",
    spMyMaterials: "My Materials",
    spMyWorks: "My Works",
    spSettings: "Settings",
    spEngineeringLabs: "Armath Engineering Labs",
    spWelcomeBack: "Welcome back",
    spProgressOverview: "Here's an overview of your learning progress.",
    spTotalMaterials: "Total Materials",
    spWorksSubmitted: "Works Submitted",
    spRecentMaterials: "Recent Materials",
    spRecentWorks: "Recent Works",
    spViewAll: "View all",
    spNoMaterialsAssigned: "No materials assigned yet",
    spNoWorksYet: "No works submitted yet",
    spViewMaterials: "View Materials",
    spContinueLearning: "Continue your learning journey",
    spUploadWork: "Upload Work",
    spSubmitProjects: "Submit your projects and assignments",
    spMyMaterialsTitle: "My Materials",
    spTrackMaterials: "Track your assigned learning materials",
    spFilterAll: "All",
    spFilterNotStarted: "Not Started",
    spFilterInProgress: "In Progress",
    spFilterCompleted: "Completed",
    spNoMaterialsFound: "No materials found",
    spTryDifferentFilter: "Try a different filter",
    spAdminWillAssign: "Your admin will assign materials to you",
    spOpenMaterial: "Open Material",
    spStartLearning: "Start Learning",
    spMarkComplete: "Mark as Complete",
    spCompletedStatus: "Completed",
    spMyWorksTitle: "My Works",
    spSubmitTrackWorks: "Submit and track your project works",
    spHideForm: "Hide Form",
    spUploadFirstWork: "Upload your first work to get started",
    spDownload: "Download",
    spEdit: "Edit",
    spDelete: "Delete",
    spDeleteConfirm: "Delete this work?",
    spYes: "Yes",
    spNo: "No",
    spTitleLabel: "Title",
    spDescriptionLabel: "Description",
    spSave: "Save",
    spCancel: "Cancel",
    spFeedbackLabel: "Feedback",
    spAuthorAdmin: "Admin",
    spAuthorYou: "You",
    spNoFeedbackYet: "No feedback yet",
    spStatusSubmitted: "Submitted",
    spStatusReviewed: "Reviewed",
    spStatusNeedsRevision: "Needs Revision",
    spStatusApproved: "Approved",
    spStatusNotStarted: "Not Started",
    spStatusInProgress: "In Progress",
    spSettingsTitle: "Settings",
    spSettingsSubtitle: "View your profile and manage your password",
    spProfileInfo: "Profile Information",
    spProfileManagedByAdmin: "Your profile information is managed by your administrator. Contact them if you need any changes.",
    spChangePasswordTitle: "Change Password",
    spLabelUsername: "Username",
    spLabelFullName: "Full Name",
    spLabelAge: "Age",
    spLabelParentContact: "Parent Contact",
    spLabelEmail: "Email",
    spLabelLanguage: "Language",
    spLangArmenian: "Armenian",
    spLangEnglish: "English",
    spPasswordChangeRequired: "Password Change Required",
    spMustChangeTempPassword: "You must change your temporary password before continuing.",
    spCurrentPassword: "Current Password",
    spNewPassword: "New Password",
    spNewPasswordHint: "At least 8 characters",
    spConfirmNewPassword: "Confirm New Password",
    spChangePasswordBtn: "Change Password",
    spChangingPassword: "Changing Password...",
    spPasswordChanged: "Password changed successfully!",
    spNotifications: "Notifications",
    spMarkAllRead: "Mark all read",
    spNoNotifications: "No notifications",
    spNotProvided: "Not provided",
    spDue: "Due",
    spPasswordsDontMatch: "Passwords do not match",
    spPasswordMinLength: "New password must be at least 8 characters",
    spTitleMinChars: "Title must be at least 2 characters",
    spFailedUpdateWork: "Failed to update work",
    spUploadNewWork: "Upload New Work",
    spOptional: "optional",
    spRelatedMaterial: "Related Material",
    spNone: "None",
    spFileLabel: "File",
    spDragAndDrop: "Drag & drop or",
    spBrowse: "browse",
    spFileTooLarge: "File must be less than 10MB",
  ...
  hy: {
    ...
    // Student Portal (HY translations — pending, fallback to EN)
    spPortalTitle: "",
    spPortalSignIn: "",
    spUsernameLabel: "",
    spPasswordLabel: "",
    ...
    spSettingsSubtitle: "",
    spProfileInfo: "",
    spProfileManagedByAdmin: "",
    spChangePasswordTitle: "",
    spLabelUsername: "",
    spLabelFullName: "",
    spLabelAge: "",
    spLabelParentContact: "",
    spLabelEmail: "",
    spLabelLanguage: "",
    spLangArmenian: "",
    spLangEnglish: "",
    spPasswordChangeRequired: "",
    spMustChangeTempPassword: "",
    spCurrentPassword: "",
    spNewPassword: "",
    spNewPasswordHint: "",
    spConfirmNewPassword: "",
    spChangePasswordBtn: "",
    spChangingPassword: "",
    spPasswordChanged: "",
    spNotifications: "",
